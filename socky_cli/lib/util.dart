...
Directory get sockyDir => Directory(p.join(homeDir.path, '.socky'));

/* Future<Pubspec> loadSockyYaml([Directory directory]) {
  directory ??= Directory.current;
  var file = new File.fromUri(directory.uri.resolve('socky.yaml'));
  return file
      .readAsString()
